// BOOKMARKLET V3.0 - LOTECA PRO
// Captura dados da Caixa (Programação ou Resultados)
        ...
        if (table) {
            ...
            rows.forEach((row, idx) => {
                ...
                if (cells.length >= 7) {
                    jogos.push({
                        jogo: idx + 1,
                        time1: cells[2].textContent.trim(), // mandante
                        time2: cells[4].textContent.trim(), // visitante
        ...
        if (table) {
            ...
            rows.forEach((row, idx) => {
                ...
                if (cells.length >= 7) {
                    jogos.push({
                        jogo: idx + 1,
                        time1: cells[1].textContent.trim(), // mandante
                        placar1: parseInt(cells[0].textContent.trim()) || 0,
                        time2: cells[3].textContent.trim(), // visitante
                        placar2: parseInt(cells[4].textContent.trim()) || 0,
